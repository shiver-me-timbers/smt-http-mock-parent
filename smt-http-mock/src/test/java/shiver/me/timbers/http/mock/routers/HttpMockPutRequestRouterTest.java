...
public class HttpMockPutRequestRouterTest {

    private HttpMockPutRequestRouter router;

    @Before
    public void setUp() {
        router = new HttpMockPutRequestRouter();
    }

    @Test
    public void Can_handle_a_put_method() {

        // When
        final boolean actual = router.handlesMethod(PUT);
    ...
    @Test
    public void Can_handle_a_put_request_with_headers() {
        ...
        // Given
        given(handler.put(path, headers)).willReturn(expected);
