...
public class HttpMockPatchRequestRouterTest {
    ...
    private HttpMockPatchRequestRouter router;

    @Before
    public void setUp() {
        router = new HttpMockPatchRequestRouter();
    }

    @Test
    public void Can_handle_a_patch_method() {

        // When
        final boolean actual = router.handlesMethod(PATCH);
    ...
    @Test
    public void Can_handle_a_patch_request_with_headers() {
        ...
        // Given
        given(handler.patch(path, headers)).willReturn(expected);
