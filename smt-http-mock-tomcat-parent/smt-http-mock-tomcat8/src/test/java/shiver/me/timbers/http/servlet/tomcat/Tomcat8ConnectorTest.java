...
public class Tomcat8ConnectorTest {

    private Connector connector;
    private Tomcat8Connector tomcat8Connector;

    @Before
    public void setUp() {
        connector = mock(Connector.class);
        tomcat8Connector = new Tomcat8Connector(connector);
    }
    ...
    public void Can_allow_trace() {
        ...
        // When
        tomcat8Connector.setAllowTrace(allowTrace);
    ...
    public void Can_get_the_local_port() {
        ...
        // When
        final int actual = tomcat8Connector.getLocalPort();
